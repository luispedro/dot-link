...
The one-error dotted tree for \putstring{mississipi} is shown in Figure~\ref{fig:mississipi-1}. The nodes are connected to their error trees by diagonal links.
