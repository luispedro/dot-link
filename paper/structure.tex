...
Suffix Trees have become a well known structure since their introduction in 1973~\cite{weiner}. In Figure~\ref{fig:mississippi-0} we show the suffix tree for the string \putstring{mississippi}.
